...
$(call add_json_bool, Needs_camera_boottime, $(filter true,$(TARGET_CAMERA_BOOTTIME_TIMESTAMP)))
...
$(call add_json_val_default, Target_inputdispatcher_skip_event_key, $(TARGET_INPUTDISPATCHER_SKIP_EVENT_KEY), 0)
